          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="space-y-12">
              <div className="flex items-start gap-6">
                <div className="w-12 h-12 bg-vdas-royal/10 text-vdas-royal rounded-xl flex items-center justify-center shrink-0">
            ...
            {/* Form */}
            <div className="bg-slate-50 p-10 lg:p-16 rounded-[3rem] border border-slate-100 shadow-xl">
              <h2 className="text-2xl font-black text-slate-900 mb-8 tracking-tight uppercase">Send a Message</h2>
              <ContactForm />
            </div>
          </div>
        </div>
