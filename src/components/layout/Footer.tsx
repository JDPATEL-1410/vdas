      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-16 mb-24 items-start">
          <div className="lg:col-span-4 space-y-12">
            ...
            {/* Social Icons - Now Properly Placed here or bottom */}
            <div className="flex items-center gap-4 pt-4">
              {SOCIAL_LINKS.map(s => (
                <a 
                  ...
                  className="w-12 h-12 rounded-2xl bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-400 hover:text-white hover:bg-vdas-orange hover:border-vdas-orange hover:shadow-xl transition-all duration-500 group"
                  title={s.label}
                >
